...
fn main() -> anyhow::Result<()> { 
    ...
    text.load_font("assets/NotoColorEmoji.ttf", 12)?;
    let base_font = text.load_font("assets/NotoSans-Regular.ttf", 12)?;
    text.load_font("assets/NotoSansArabic-Regular.ttf", 12)?;
    text.load_font("assets/NotoSansHebrew-Regular.ttf", 12)?;
